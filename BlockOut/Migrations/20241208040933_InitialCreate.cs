        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Calendars_AspNetUsers_AvailabilityUserId",
                        column: x => x.AvailabilityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Calendars_AspNetUsers_PreferencesUserId",
                        column: x => x.PreferencesUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Calendars_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenHours_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBusinessCalendars_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBusinessCalendars_Calendars_CalendarId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Calendars_AvailabilityUserId",
                table: "Calendars",
                column: "AvailabilityUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Calendars_BusinessId",
                table: "Calendars",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_Calendars_PreferencesUserId",
                table: "Calendars",
                column: "PreferencesUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OpenHours_BusinessId",
                table: "OpenHours",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBusinessCalendars_BusinessId",
                table: "UserBusinessCalendars",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBusinessCalendars_CalendarId",
                table: "UserBusinessCalendars",
                column: "CalendarId");
